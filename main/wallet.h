...
void wallet_get_default_xpub_export_path(network_t network_id,
...
bool wallet_get_message_hash(
    const uint8_t* bytes, size_t bytes_len, network_t network_id, uint8_t* output, size_t output_len);
